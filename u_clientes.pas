...
begin
     ...
     begin
          ShowMessage('A janela de edição já está em Execução !');
          f_fichacliente.Show;
          exit;
     end;
     ...
     begin
          MessageDlg('Não há um registro para ser alterado !',mtError,[mbOk],0);
          exit;
     end;
...
begin
     if q_dados.IsEmpty then
     begin
          MessageDlg('Não há um registro para ser Excluído !',mtError,[mbOk],0);
          exit;
     end;
