...
begin
     ...
     begin
          ShowMessage('Você não possui permissão a este modulo!!!');
          exit;
     end;
     if q_dados.IsEmpty then
     begin
       ShowMessage('Não há registro selecionado para alterar !!!');
       exit
     end;
...
begin
     ...
     if q_dados.IsEmpty then
     begin
       ShowMessage('Não há registro selecionado para excluir !!');
       exit
     end;
     erro := pode_excluir;
