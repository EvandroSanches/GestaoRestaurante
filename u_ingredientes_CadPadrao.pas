...
begin
  ...
  begin
     result := 'Não foi possivel excluir esse Ingrediente pois possui Items relacionados !';
     exit;
  end;
  ...
  if dm.Q_Geral.FieldByName('total').AsInteger > 0 then
  begin
     result := 'Não foi possivel excluir esse Ingrediente pois possui Composições relacionadas !';
     exit;
  end;
